...
export default function SearchResultCard(props: SearchResultCardProps) {
    const [recentlyPlayed, setRecentlyPlayed] = useLocalStorage<SearchResultCardProps | any>("recentlyPlayed", [])
    ...
    return (
        <article className="grid grid-cols-[75px_1fr] gap-4 w-full truncate">
            ...
            <Link
                href={getLink()}
                className={`flex flex-col justify-center truncate ${getLink() == "#" ? "cursor-default" : ""}`}>
